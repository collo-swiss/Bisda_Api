...
class DepartmentListView(GetQuerysetMixin, generics.ListCreateAPIView):
    queryset = Department.objects.order_by('id')
    serializer_class = DepartmentSerializer


class DepartmentDetailView(
        GetQuerysetMixin, generics.RetrieveUpdateDestroyAPIView):
    queryset = Department.objects.all()
    serializer_class = DepartmentSerializer


class DepartmentReportView(GetQuerysetMixin, generics.ListAPIView):
    queryset = Department.objects.order_by('id')
    serializer_class = DepartmentSerializer
    filter_class = DepartmentFilter


class UserLocationListView(GetQuerysetMixin, generics.ListCreateAPIView):
    queryset = UserLocation.objects.order_by('id')
    serializer_class = UserLocationSerializer


class UserLocationDetailView(
        GetQuerysetMixin, generics.RetrieveUpdateDestroyAPIView):
    queryset = UserLocation.objects.all()
    serializer_class = UserLocationSerializer


class UserLocationReportView(GetQuerysetMixin, generics.ListAPIView):
    queryset = UserLocation.objects.order_by('id')
    serializer_class = UserLocationSerializer
    filter_class = UserLocationFilter
