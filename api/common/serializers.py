...
class AlternateFieldsMixin(object):
    """
        Injects the fields in the abstract base model as a model
        instance is being saved.
        """
    ...
    def __init__(self, *args, **kwargs):
        super(AlternateFieldsMixin, self).__init__(*args, **kwargs)
    ...
    def update(self, instance, validated_data):
        ...
        return super(AlternateFieldsMixin, self).update(instance, validated_data)
